...
- [Sem perda de informação:]{.alert} pode-se usar a perturbação, adicionando uma valor constante aos valores numéricos. 
...
- **Exemplo:** um conjunto de dados de clientes pode conter um atributo de idade (com valores entre 0 e 100) e um atributo de renda (com valores entre 1.000 e 30.000).
  
E por que atributos com escalas muito diferentes podem afetar o desempenho de alguns algoritmos de mineração de dados?

- Algoritmos baseados em distância (p.ex., k-NN e agrupamento hierárquico) podem ser influenciados por atributos com escalas maiores, fazendo com que esses atributos tenham maior influência no modelo do que atributos com escalas menores.
