...
- ***Adaptive Synthetic Sampling Approach for Imbalanced Learning (ADASYN)*** -- sobreamostragem baseada na geração de instâncias sintéticas com ênfase em instâncias difíceis de classificar.
:::
:::
