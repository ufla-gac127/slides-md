...
[Discretização Supervisionada com MDLP]{.alert}
...
[Aplicar critério MDL:]{.alert .fontsize90}

- Verifica se o ganho de informação compensa a complexidade  
- Se compensar → aceita o corte  
