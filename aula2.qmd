...
- **Inconsistências**: [Valores inconsistentes]{.alert} de atributos ou [informações conflitantes]{.alert}. 
  - Exemplo: um registro de uma pessoa com 3 anos que tem formação em curso de nível superior.
- **Ruídos e *Outliers***: Dados que contêm [erros]{.alert} e [valores atípicos]{.alert} que podem distorcer a análise. 
...
- **Valores ausentes**: [Ausência de valores]{.alert} de atributos. 
